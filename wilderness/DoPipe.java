...
public class DoPipe extends Node {

	@Override
	public boolean activate() {
		return Data.WildAgilityCourse.contains(Players.getLocal().getLocation()) && !Data.hasFallen && Players.getLocal() != null && Data.PipeStart.contains(Players.getLocal().getLocation());
	}
	...
	public void execute() {
		...
		Data.status = "Doing pipe...";	
		if (Players.getLocal().getLocation().equals(Data.PipeEntry)) {
			Data.lapDone = false;
		}
		...
		if (pipe.isOnScreen()) {
			...
			Camera.turnTo(pipe, Random.nextInt(-25, 25));
		}
	}
